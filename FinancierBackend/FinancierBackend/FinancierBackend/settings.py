"""
Django settings for FinancierBackend project.
...
SECRET_KEY = 'django-insecure-ch-bu@+ug^n3x0dnp$jn4l)*2#9@v#scjd!ouero2a7j37z8y9'
...
ROOT_URLCONF = 'FinancierBackend.urls'
